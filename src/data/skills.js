export const skills = [
  { id: 1, icon: 'SiHtml5', name: 'HTML5', level: 'Expert', experience: '3+ years' },
  { id: 2, icon: 'SiCss3', name: 'CSS3', level: 'Expert', experience: '3+ years' },
  { id: 3, icon: 'SiJavascript', name: 'JavaScript', level: 'Expert', experience: '3+ years' },
  { id: 4, icon: 'SiReact', name: 'ReactJS', level: 'Expert', experience: '3+ years' },
  { id: 5, icon: 'SiNextdotjs', name: 'NextJS', level: 'Advance', experience: '2+ years' },
  { id: 6, icon: 'SiTypescript', name: 'TypeScript', level: 'Intermediate', experience: '1+ years' },
